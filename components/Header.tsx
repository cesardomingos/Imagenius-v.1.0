...
const Header: React.FC<HeaderProps> = ({ onReset, hasImages, goToGallery, credits, onOpenStore, currentUser, onOpenAuth, onLogout, onOpenProfile, hasNewAchievement = false, onOpenAbout, onOpenFAQ }) => {
      ...
      <div className="container mx-auto px-3 sm:px-4 h-16 sm:h-20 flex items-center justify-between">
        <div className="flex items-center gap-5 cursor-pointer group" onClick={handleLogoClick}>
          ...
          <div className="flex flex-col">
            <h1 className="font-black text-lg sm:text-xl md:text-2xl tracking-tighter leading-none flex items-baseline">
                <span className="text-genius-gradient">Ima</span>
                <span className="text-slate-900 dark:text-white">genius</span>
            </h1>
            <span className="text-[7px] sm:text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.3em] sm:tracking-[0.4em] mt-1 sm:mt-1.5 ml-0.5">
                Generative Atelier
            </span>
          </div>
        </div>
