...
const Header: React.FC<HeaderProps> = ({ onReset, hasImages, goToGallery, credits, onOpenStore, currentUser, onOpenAuth, onLogout, onOpenProfile, hasNewAchievement = false, onOpenAbout, onOpenFAQ, onOpenTutorial }) => {
  ...
  return (
    ...
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-700 z-50 safe-area-inset-bottom">
      <div className="flex items-center justify-around h-16 px-2">
        {/* Home */}
        <button
          onClick={handleLogoClick}
          className="flex flex-col items-center justify-center gap-1 px-3 py-2 rounded-xl text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all"
        >
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-wider">Galeria</span>
        </button>

        {/* Gerar Novo - Central e Destaque */}
        <button
          onClick={onReset}
          className="flex flex-col items-center justify-center gap-1 px-4 py-2 bg-indigo-600 dark:bg-indigo-500 text-white rounded-2xl shadow-lg hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-all active:scale-95"
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-wider">Novo</span>
        </button>
        ...
        <button
          ...
          className="flex flex-col items-center justify-center gap-1 px-3 py-2 rounded-xl text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-all relative"
        >
          {hasNewAchievement && (
